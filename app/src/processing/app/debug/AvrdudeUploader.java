...
/*
  ...
  $Id: AvrdudeUploader.java 469 2008-07-14 02:09:43Z mellis $
*/
...
public class AvrdudeUploader extends Uploader  {
  ...
  protected boolean uploadViaBootloader(String buildPath, String className)
  throws RunnerException {
  ...
  protected Collection getProgrammerCommands(String programmer) {
